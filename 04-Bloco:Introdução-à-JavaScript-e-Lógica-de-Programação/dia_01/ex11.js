...
if(salario <= 1556.94){
    console.log("pagou R$" + ((salario/100)*8) + " de INSS")
    salario = salario - ((salario/100)*8);
    console.log("Salário líquido: R$" + salario);
}else if(salario >= 1556.95 && salario <= 2594.92){
    console.log("pagou R$" + ((salario/100)*9) + " de INSS")
    ...
    console.log("pagou R$" + ((salario/100)*11) + " de INSS")
    ...
    console.log("pagou R$570.88 de INSS")
